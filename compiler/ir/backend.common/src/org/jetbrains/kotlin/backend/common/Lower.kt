...
abstract class DeclarationTransformer : FileLoweringPass {
    ...
    open val withLocalDeclarations: Boolean
        get() = false
    ...
    private fun transformFlatRestricted(declaration: IrDeclaration): List<IrDeclaration>? {
        // TODO: pass stageController as a constructor parameter, and optimize it in case it's null or default controller
    ...
    private inner class Visitor : IrElementVisitorVoid {
        ...
        override fun visitFunction(declaration: IrFunction) {
            ...
            for (v in declaration.valueParameters) {
                val result = transformFlatRestricted(v)
        ...
        override fun visitProperty(declaration: IrProperty) {
            ...
            fun IrDeclaration.transform() {
                ...
                val result = transformFlatRestricted(this)
                if (result != null) {
        ...
        override fun visitClass(declaration: IrClass) {
            ...
            declaration.declarations.transformFlat(::transformFlatRestricted)
        }
